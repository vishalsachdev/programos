...
Cite as `[curriculum:program/policies/admissions.md]` or `[box:syllabi/BADM550-S26.pdf, read 2026-05-02T14:31Z]`. Quote the cited excerpt verbatim from extra mounts so the channel handler can hash and snapshot it for audit. See `docs/10-content-sources.md`.
...
- **Markdown V2.** Escape `_*[]()~>#+-=|{}.!` in your reply before sending. Citations should be plain text, not links: `[curriculum:program/CURRICULUM.md line 42]` or `[box:syllabi/BADM550-S26.pdf, read 2026-05-02T14:31Z]`. Remember to escape the citation brackets per Markdown V2 rules.
